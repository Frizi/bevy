...
impl<'w> WorldCell<'w> {
    ...
    pub fn get_resource<T: Component>(&self) -> Option<WorldCellRes<'_, T>> {
    ...
    pub fn get_resource_mut<T: Component>(&self) -> Option<WorldCellResMut<'_, T>> {
        ...
        Some(WorldCellResMut::new(
            ...
            unsafe { world.get_resource_unchecked_mut_with_id(component_id)? },
            archetype_component_id,
            &self.state,
        ))
    }
